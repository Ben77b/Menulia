    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-xs text-gray-500">
          Or use <Link href="/logout" className="text-indigo-600 hover:underline">Sign out</Link> from
          any device.
        </p>
      </div>
      ...
      <div className="rounded-xl border-2 border-red-200 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-red-100 bg-red-50 p-4">
            ...
            <Button variant="outline" className="gap-2 shrink-0" onClick={handleDownloadData}>
          ...
          <div className="flex items-center justify-between rounded-lg border border-red-100 bg-red-50 p-4">
            ...
            <Button variant="danger" className="gap-2 shrink-0" onClick={handleDeleteAccount}>
