...
const UI_STRINGS: Record<string, Record<DashboardLocale, string>> = {
  ...
  "home.analyticsRange30d": { en: "30 Days", es: "30 días" },
  "home.analyticsRange1y": { en: "1 Year", es: "1 año" },
  "home.analyticsRangeAll": { en: "All-Time", es: "Todo" },
  "home.analyticsZeroState": {
    en: "No menu scans recorded yet — share your QR code to start tracking traffic!",
    es: "Aún no hay escaneos registrados: comparte tu código QR para empezar a medir el tráfico.",
  },
  "home.analyticsZeroCta": { en: "Open QR tools", es: "Abrir herramientas QR" },
  "home.analyticsPrivacyNote": {
    en: "Privacy-safe tracking: language and device type only. No IP addresses or personal data.",
    es: "Seguimiento respetuoso con la privacidad: solo idioma y tipo de dispositivo. Sin IP ni datos personales.",
  },
  "home.trafficTitle": {
  ...
  "builder.actions.editCategoryNote": { en: "Edit note", es: "Editar nota" },
  "builder.actions.lockCategoryTitle": {
    en: "Do not translate this category title",
    es: "No traducir el título de esta categoría",
  },
