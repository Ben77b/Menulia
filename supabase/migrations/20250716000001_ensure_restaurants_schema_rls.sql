-- Align ensure_restaurants_schema with owner-scoped write policies (no FOR ALL bypass).
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'restaurants'
      AND policyname = 'Owners insert restaurants'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'restaurants'
      AND policyname = 'Owners update restaurants'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'restaurants'
      AND policyname = 'Owners delete restaurants'
  ) THEN
